  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 max-w-7xl mx-auto">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-[600px] w-[600px] md:h-[800px] md:w-[800px] bg-red-500/[0.18] rounded-full blur-[120px] md:blur-[100px] animate-pulse" />

        
        <div
          className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-[500px] w-[500px] md:h-[700px] md:w-[700px] bg-orange-500/[0.12] rounded-full blur-[100px] md:blur-[80px] animate-pulse"
