  ...
  return (
    ...
    >
      <AnimatePresence>
        {hoveredIndex === idx && (
          <motion.span
            className="absolute inset-0 h-full w-full bg-border/40 rounded-3xl z-0"
      ...
      <div className="flex flex-col h-full bg-card p-4 rounded-3xl relative z-10 shadow-lg shadow-slate-500/20 border border-border">
        <div
...
const ProfilesSection = () => {
  ...
  const handleAllProfilesClick = () => {
    trackExternalLinkProfiles(
      "https://codolio.com/profile/Avinash_Umrao",
    ...
    >
      <div className="max-w-6xl mx-auto">
        <Header
          ...
          subtitle="Explore my competitive programming journey across multiple platforms"
          gradient={true}
          align="center"
          className="mb-3"
        />
